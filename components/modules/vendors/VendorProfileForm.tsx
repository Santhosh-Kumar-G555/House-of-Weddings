...
export default function VendorProfileForm({ vendorData, isAdmin = false, dynamicCategories = EMPTY_CATEGORIES }: { vendorData: any, isAdmin?: boolean, dynamicCategories?: any[] }) {
